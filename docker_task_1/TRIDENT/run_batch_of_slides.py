...
def run_task(processor, args):
    ...
    if args.task == 'seg':
        ...
        end_time = time.time()
        print(f"[PROCESSOR] Segmentation completed in {end_time - start_time:.2f} seconds.")
        ...
        end_time = time.time()
        print(f"[PROCESSOR] Patching completed in {end_time - start_time:.2f} seconds.")
    elif args.task == 'feat':
        start_time = time.time()
        ...
        end_time = time.time()
        print(f"[PROCESSOR] Feature extraction completed in {end_time - start_time:.2f} seconds.")
    else:
